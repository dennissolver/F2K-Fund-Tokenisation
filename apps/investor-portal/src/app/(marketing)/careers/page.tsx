    ...
    roles: [
      {
        ...
        location: "National",
        type: "Non-executive",
        desc: "Aboriginal and First Nations Housing Leader. Critical for credibility with NT/WA Aboriginal housing programs and government stakeholder trust. This appointment signals F2K's commitment to community-led housing delivery.",
        requirements: [
          ...
          "Government stakeholder relationships across multiple jurisdictions",
